...
WebDriver dr;
	...
	public void bm() {
		ut=new utilities();
		dr=ut.launch_browser("FIREFOX", url); //launches the firefox browser
		
	}
	
	
  @Test(dataProvider="project")
  public void f(String s_uid,String s_pwd,String l_uid,String l_pwd,String el,String cn,String tm,String a) throws InterruptedException, IOException {
